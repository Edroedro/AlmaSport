...
<head>
    ...
    <link rel="stylesheet" href="styles/tennis.css">
      ...
      <nav>
        ...
        <div class="container_grande">
            ...
            <div class="container_piccolo">
                <div class="immagine"><img src="sfondi/allenamento_tennis.jpg" width="450px", height="450px"></div>
                <div class="testo1">Immagina di varcare i cancelli del campo da tennis, la racchetta stretta tra le mani, pronto a sfidare te stesso in un viaggio emozionante verso la padronanza di questo affascinante sport. 
                    Il tennis non è solo un gioco, ma anche un modo fantastico per mantenerti in forma e in salute. Con ogni scambio di palla, stai lavorando su forza, resistenza, agilità e coordinazione, mantenendo il tuo corpo al meglio delle sue capacità. 
                    Non è solo uno scontro di forza fisica, ma anche una battaglia mentale. Ogni partita di tennis è una sfida unica. Ti sfiderà a migliorare le tue abilità, a pensare in modo strategico e a adattarti rapidamente alle mutevoli circostanze del gioco. 
                    Questo costante stimolo ti porterà a crescere come individuo, accettando e superando sfide con grinta e determinazione. Il tennis è uno sport che si gioca da soli, ma che si vive insieme. 
                    Unisciti a una comunità appassionata di giocatori di tennis, fatta di amicizie solide e legami duraturi. Condividerai vittorie, sconfitte e momenti indimenticabili sul campo, creando ricordi che dureranno per sempre.
                </div>
                    <div class="orari">
                <h1> GLI ALLENAMENTI SI SVOLGONO:</h1>
                <ul>
                    <li>Mercoledì:Ore 15:00 - 16:30 presso Tennis Club Roma in Viale delle Olimpiadi</li>
                    <li>Sabato :Ore 14:00 - 15:30 presso Tennis Club Roma in Viale delle Olimpiadi  </li>               
