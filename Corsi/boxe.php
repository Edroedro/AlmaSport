      ...
      <nav>
        ...
        <div class="container_grande">
            ...
            <div class="container_piccolo">
                <div class="immagine"><img src="sfondi/allenamento_boxe.jpg" width="450px", height="450px"></div>
                <div class="testo1">La boxe ti farà sentire più forte e più resistente, sia mentalmente che fisicamente. Ogni allenamento ti porterà un passo più vicino alla tua migliore versione. 
                    Richiede disciplina e concentrazione, qualità che si tradurranno positivamente in tutti gli aspetti della tua vita. Ogni combattimento è una sfida, un'opportunità per superare i tuoi limiti e crescere come individuo. 
                    Non perdere l'opportunità di fare parte di questa incredibile avventura. 
                    Iscriviti ora al Corso Universitario di Boxe e inizia il tuo viaggio verso la tua migliore versione!
                </div>
            <div class="orari">
                <h1> GLI ALLENAMENTI SI SVOLGONO:</h1>
                <ul>
                    <li>Martedì ore: 19:00-20:30 presso Roma Combat Sports Center in Via Ostiense</li>
                    <li>Giovedì ore: 16:00-17.30 presso Roma Combat Sports Center in Via Ostiense</li>
                </ul>
            </div>
        </div>
        <footer>
