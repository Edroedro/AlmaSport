...
<head>
    ...
    <link rel="stylesheet" href="styles/padel.css">
      ...
      <nav>
        ...
        <div class="container_grande">
            ...
            <div class="container_piccolo">
                <div class="immagine"><img src="sfondi/allenamento_padel.jpg" width="450px", height="450px"></div>
                <div class="testo1">Sei pronto per un'avventura sportiva che ti porterà a scoprire una nuova passione e a vivere emozioni uniche? Il Corso Universitario di Padel è l'opportunità perfetta per te! 
                    Immagina di immergerti in un gioco avvincente, un incrocio tra tennis e squash, in un ambiente dinamico e stimolante. Ogni partita è un'esperienza unica, fatta di scambi veloci, tattiche intelligenti e momenti entusiasmanti. 
                    Non importa se sei un principiante o un esperto, il padel ti darà sempre qualcosa di cui entusiasmarti. Inoltre è uno sport accessibile a tutti, con regole semplici e una curva di apprendimento rapida. 
                    Con campi disponibili in molte strutture sportive, è facile trovare un luogo dove giocare e praticare regolarmente.
                </div>
                    <div class="orari">
                <h1> GLI ALLENAMENTI SI SVOLGONO:</h1>
                <ul>
                    <li>Mercoledì:Ore 15:00 - 16:30 presso Padel Prestige Club in Via di Grotta Perfetta</li>
                    <li>Sabato :Ore 14:00 - 15:30 presso Padel Prestige Club in Via di Grotta Perfetta </li>               
